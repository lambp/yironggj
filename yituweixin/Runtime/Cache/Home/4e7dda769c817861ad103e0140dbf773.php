...
<body>
    <p><span style="color:#F00">产品管理</span> </p>
	...
	<center>
		<table width="80%" border="0"  cellspacing="0" cellpadding="0" class="tableborder">
		  ...
		  <?php if(is_array($product_list)): foreach($product_list as $key=>$list): ?><tr>
			...
			<td>
				...
				<a href='/?m=admin&a=delete_product&id=<?php echo ($list["id"]); ?>' >删除</a></td>
